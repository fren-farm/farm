        ...
        <div>
             ...
             */}
                ...
                <CardBody>
                    <Container>
                         <Heading size="md">Your Referral Link</Heading>
                         {/* <CopyToClipboard text={`https://polyFREN.com/?ref=${rot13(account)}`} onCopy={()=> {handleClick()}}> */}
                ...
                <StyledFooter >
                    {/* <StyledLink style={{"margin":"auto"}}>{`https://polyFREN.com/?ref=${rot13(account)}`}</StyledLink> */}
                    <StyledLink style={{"margin":"auto"}}>{`http://frenbase.xyz/?ref=${rot13(account)}`}</StyledLink>
                </StyledFooter>
