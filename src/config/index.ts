...
// 20 Fren PER block is sent to Burn pool (A farm just for burning cake)
// 10 Fren PER block goes to CAKE syrup pool
// 9 Fren PER block goes to Yield farms and lottery
...
export const BASE_URL = 'https://fren-farm.com'
